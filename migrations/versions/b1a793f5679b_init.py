...
Revision ID: b1a793f5679b
Revises: 
Create Date: 2024-01-15 09:50:12.321657
...
def upgrade() -> None:
    ...
    sa.Column('qr_code_url', sa.String(length=255), server_default='', nullable=True),
    sa.ForeignKeyConstraint(['image_id'], ['images.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
